...
// Nykyinen koko ~121 kt. Raja on 15 % alle sen, mutta selvasti yli
// alaskannatun buildin (~64 kt), jotta normaali vaihtelu ei laukaise tata.
const MIN_BYTES = 103_000;
// Luokat jotka tulevat VAIN taman sivuston src/:sta -- ei shared/:sta.
const REQUIRED = ['bg-night-light', 'text-neon-yellow', 'border-pink'];
