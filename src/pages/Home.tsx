...
const CONNECT_LEAD: Record<Lang, { eyebrow: string; h: string }> = {
  ...
  es: { eyebrow: 'Antes de salir', h: 'Resuelva sus datos antes de que empiece la noche' },
  ...
  fr: { eyebrow: 'Avant de partir', h: 'Réglez vos données mobiles avant que la nuit commence' },
