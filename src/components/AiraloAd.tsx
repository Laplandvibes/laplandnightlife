...
export default function AiraloAd({
  ...
  const headline = pick({
    ...
    nl: 'Land in Lapland met data al op uw telefoon. Airalo is een eSIM die u vóór de vlucht instelt.',
  ...
  const sub = pick({
    ...
    es: 'Sin cambiar de SIM, sin factura de roaming, sin colas en la tienda del aeropuerto. Elija un plan de Finlandia o de Europa, instálelo en un par de minutos y sus mapas, apps de transporte e historias funcionan en cuanto quita el modo avión.',
    ...
    nl: 'Geen simwissel, geen roamingrekening, geen rij in de luchthavenwinkel. Kies een Finland- of Europa-bundel, installeer hem in een paar minuten en uw kaarten, rit-apps en stories werken zodra u de vliegtuigstand uitzet.',
  ...
  const trust: { icon: typeof Globe; label: string }[] = [
    {
      ...
      label: pick({
        ...
        nl: 'In minuten klaar, vóór uw vlucht',
