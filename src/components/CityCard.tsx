    ...
    >
      <div className="aspect-[4/3] relative overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <p className="text-[0.65rem] uppercase tracking-[0.2em] text-white/50 mb-1">{city.region}</p>
          <h3 className="font-heading text-2xl text-white tracking-tight leading-none">{city.name}</h3>
        </div>
      </div>
      <div className="p-5">
        <p className="text-sm text-white/70 leading-relaxed">{city.blurb}</p>
