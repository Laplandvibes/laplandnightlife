...
const overlay: Record<string, CityOverlay> = {
  ...
  rovaniemi: {
    ...
    quickFacts: {
      ...
      'Best season': { label: 'Beste seizoen', value: 'sep–mrt (noorderlicht) · dec (Kerstman)' },
    },
  },
  levi: {
  ...
  saariselka: {
    ...
    knowList: [
      ...
      'Een noorderlicht-app is onmisbaar. Het personeel wekt gasten om 02:00 als het actief is.',
    ],
    quickFacts: {
      ...
      'Best season': { label: 'Beste seizoen', value: 'sep–mrt (noorderlicht)' },
    },
  },
  inari: {
    region: 'Gemeente Inari',
    ...
    quickFacts: {
      ...
      'Best season': { label: 'Beste seizoen', value: 'half aug (Ijahis Idja) · jan (Skábmagovat)' },
    },
  },
  kemi: {
    region: 'Zee-Lapland',
  ...
  'pyha-luosto': {
    ...
    knowList: [
      ...
      'De amethistmijn biedt nachttochten onder het noorderlicht. Boek van tevoren.',
    ...
    quickFacts: {
      ...
      'Last call': { label: 'Laatste ronde', value: '01:00' },
      'Best season': { label: 'Beste seizoen', value: 'dec–apr (skiën) · sep–mrt (noorderlicht)' },
    },
  },
  sodankyla: {
  ...
  ivalo: {
    ...
    quickFacts: {
      ...
      'Best season': { label: 'Beste seizoen', value: 'sep–mrt (noorderlicht) · aug (festivals)' },
    },
  },
  muonio: {
    region: 'West-Lapland',
    ...
    quickFacts: {
      ...
      'Best season': { label: 'Beste seizoen', value: 'sep–mrt (noorderlicht · weinig lichtvervuiling)' },
    },
  },
  salla: {
    region: 'Oost-Lapland',
