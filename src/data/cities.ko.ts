...
const overlay: Record<string, CityOverlay> = {
  ...
  rovaniemi: {
    ...
    knowList: [
      '코스키카투와 보행자 거리에 밤 문화의 거의 전부가 모여 있습니다. 모두 걸어서 이동 가능합니다.',
      '라스트 콜은 03:00; 클럽은 겨울 03:30, 성수기엔 때로 04:00까지.',
    ...
    quickFacts: {
      ...
      'Last call': { label: '라스트 콜', value: '03:00' },
  ...
  levi: {
    ...
    knowList: [
      ...
      '시즌 중 라스트 콜은 03:30; 월드컵 주간엔 더 늦게까지 하는 곳도 있습니다.',
  ...
  saariselka: {
    ...
    knowList: [
      '독립 클럽 없음: 나이트라이프는 호텔 중심입니다.',
      'Kakslauttanen 투숙객이 아니라면 Igloo Bar는 예약 필수.',
      '공항(Ivalo)에서 도로로 25분. 마실 거라면 차량 픽업을 예약하세요.',
      '오로라 예보 앱은 필수. 오로라가 뜨면 직원이 02:00에라도 손님을 깨웁니다.',
    ],
    quickFacts: {
      'Beds in village': { label: '마을 객실 침대 수', value: '7,500' },
      'Closest airport': { label: '가장 가까운 공항', value: 'IVL · 25분' },
      'Last call': { label: '라스트 콜', value: '01:30 (호텔)' },
  ...
  inari: {
    ...
    knowList: [
      ...
      '원주민 영화제 Skábmagovat는 1월 말. 숙소가 동납니다.',
      'Ijahis Idja 축제(8월 중순): Inari에 "밤 문화"라 부를 만한 게 있다면 이게 가장 가깝습니다.',
      '어디서든 마시기 전에 Sajos와 Siida는 꼭 들러야 할 문화 방문지.',
    ],
    quickFacts: {
      'Population': { label: '인구', value: '6,800' },
      'Closest airport': { label: '가장 가까운 공항', value: 'IVL · 40분' },
      'Last call': { label: '라스트 콜', value: '01:00' },
  ...
  kemi: {
    ...
    knowList: [
      '대부분의 무대는 1월부터 4월까지 SnowCastle 안에 있습니다.',
      'Sampo 쇄빙선은 성수기엔 2~3일 전 예약이 필요합니다.',
      '시내 라스트 콜은 02:00, SnowCastle 바는 더 일찍 닫습니다 (보통 24:00).',
      '헬싱키에서 기차로 직행 8시간.',
    ],
    quickFacts: {
      'Population': { label: '인구', value: '20,800' },
      'Closest airport': { label: '가장 가까운 공항', value: 'KEM · 5분 · 또는 헬싱키발 철도' },
      'Last call': { label: '라스트 콜', value: '02:00' },
  ...
  yllas: {
    ...
    knowList: [
      '애캐스와 윌래스야르비는 차로 20분 거리. 택시는 미리 계획하세요.',
      '라스트 콜은 02:00쯤. 레비보다 이릅니다.',
      '클럽은 없습니다. 바뿐입니다.',
  ...
  ruka: {
    ...
    quickFacts: {
      ...
      'Last call': { label: '라스트 콜', value: '03:00 (시즌 중)' },
  ...
  'pyha-luosto': {
    ...
    knowList: [
      'Pyhä-Luosto 어디에도 나이트클럽은 없습니다.',
      '자수정 광산은 오로라 아래 야간 투어를 제공합니다. 사전 예약하세요.',
      'Pyhä-Luosto 국립공원이 조용한 매력의 원천입니다.',
      '양쪽 마을 모두 라스트 콜은 01:00 무렵.',
    ],
    quickFacts: {
  ...
  kittila: {
    ...
    quickFacts: {
      ...
      'Last call': { label: '라스트 콜', value: '02:00' },
      'Best season': { label: '최적 시즌', value: '사계절 (Levi 직원들의 밤)' },
    },
  },
  ivalo: {
    region: 'Inari 지자체',
    ...
    knowList: [
      '핀란드 본토 최북단 공항.',
      'Saariselkä가 25분 거리. 많은 Saariselkä 방문객이 호텔 바를 찾아 차로 넘어옵니다.',
      '라스트 콜은 평일 02:00, 주말 03:00.',
      '택시 승강장 없음. 호텔 프런트를 통해 예약하세요.',
    ],
    quickFacts: {
      'Population': { label: '인구', value: '4,000' },
      'Closest airport': { label: '가장 가까운 공항', value: 'IVL · 5분' },
      'Last call': { label: '라스트 콜', value: '02:00 / 주말 03:00' },
  ...
  muonio: {
    ...
    quickFacts: {
      ...
      'Last call': { label: '라스트 콜', value: '23:00 / 주말 01:00' },
  ...
  salla: {
    ...
    quickFacts: {
      ...
      'Last call': { label: '라스트 콜', value: '23:00 / 시즌 중 01:00' },
